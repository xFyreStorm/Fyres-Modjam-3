...
import fyresmodjam3.models.ModelCrystalStand;
...
public class TileEntityCrystalStandRenderer extends TileEntitySpecialRenderer {
	...
	public static ResourceLocation texture = new ResourceLocation("fyresmodjam3", "textures/blocks/crystal_stand.png");
	...
	public void renderTileEntityAt(TileEntity tileentity, double d0, double d1, double d2, float f) {
		...
		Block block = FyresModjam3.crystalStand;
